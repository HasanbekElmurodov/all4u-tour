...
<html lang="en">
<head>
    <title>All4u Tour admin dashboard</title>
        ...
        <div id="app-sidepanel" class="app-sidepanel">
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="{{asset('/admin/assets/images/app-logo.svg')}}" alt="logo"><span class="logo-text">All4u Tour</span></a>
					    ...
					    <li class="nav-item">
					        ...
					        <a class="nav-link active" href="/dashboard">
						        <span class="nav-icon">
		                         ...
		                         <span class="nav-link-text">Asosiy sahifa</span>
					        </a><!--//nav-link-->
					    </li><!--//nav-item-->
					    <li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
